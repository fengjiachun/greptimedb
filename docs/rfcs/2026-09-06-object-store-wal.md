...
| conflicting object | unchanged | every batch that is not durable fails | poisoned |
| encoding or catalog error | unchanged | every batch that is not durable fails | poisoned |
